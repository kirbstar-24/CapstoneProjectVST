/*
  ==============================================================================
    ...
    This file contains the code for the custom style using JUCE's custom look 
    and feel class.
...
{
public:
    static constexpr uint32_t COL_BG = 0xFF080E0A;
    static constexpr uint32_t COL_PANEL = 0xFF0A1410;
    static constexpr uint32_t COL_BORDER = 0xFF0F2A18;
    static constexpr uint32_t COL_KNOB_BG = 0xFF081008;
    static constexpr uint32_t COL_KNOB_RING = 0xFF143D1E;
    static constexpr uint32_t COL_TEXT = 0xFF3A7A50;
    ...
    Style()
    {
        ...
        setColour(juce::Slider::backgroundColourId, juce::Colour(COL_KNOB_BG));

        // box
        setColour(juce::ComboBox::backgroundColourId, juce::Colour(0xFF0A0A0E));
        setColour(juce::ComboBox::outlineColourId, juce::Colour(COL_BORDER));
        setColour(juce::ComboBox::textColourId, juce::Colour(0xFF888888));
        setColour(juce::ComboBox::arrowColourId, juce::Colour(COL_TEXT));

        // menu
        setColour(juce::PopupMenu::backgroundColourId, juce::Colour(0xFF0D0D12));
        setColour(juce::PopupMenu::textColourId, juce::Colour(0xFF888888));
        setColour(juce::PopupMenu::highlightedBackgroundColourId, juce::Colour(0xFF1A1A24));
        ...
        // sliders
        setColour(juce::Slider::textBoxTextColourId, juce::Colour(0xFF666680));
        setColour(juce::Slider::textBoxBackgroundColourId, juce::Colour(0xFF0A0A0E));
        setColour(juce::Slider::textBoxOutlineColourId, juce::Colour(COL_BORDER));
    }
        ...
        float rotaryStartAngle, float rotaryEndAngle, juce::Slider& slider) override
    {
        ...
        {
            juce::Path track;
            track.addArc(centre.x - radius + 3, centre.y - radius + 3, (radius - 3) * 2.0f, (radius - 3) * 2.0f,
        ...
        {
            juce::Path arc;
            arc.addArc(centre.x - radius + 3, centre.y - radius + 3, (radius - 3) * 2.0f, (radius - 3) * 2.0f,
        ...
        // pointer
        {
            ...
            float pointerW = 2.0f;
            pointer.addRectangle(-pointerW * 0.5f, -(innerR - 2.0f), pointerW, pointerLen);
    ...
    // Combo Box
    // =========================================================
    void drawComboBox(juce::Graphics& g,int width, int height, bool, int buttonX, int buttonY,
